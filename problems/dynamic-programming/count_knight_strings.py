...
Consider a 4x4 grid containing characters 'a' to 'p'. Given a starting location (i, j) on the grid and a password length L, calculate the number of possible passwords that can be generated of length L.

You can only move between letters in the way a chess knight does - two squares vertically/horizontally, then one square horizontall/vertically.
"""
