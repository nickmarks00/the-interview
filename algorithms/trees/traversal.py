"""
A collection of different methods for traversing trees
"""
...
def pre_order_iterative(root):
    """
    - Visits the node itself, then the left subtree, then the right subtree
...
def post_order_recursive(root):
    """
    - Visits the left subtree, then the right subtree, then the node itself
    """
    if root:
...
def print_tree():
    """
    Utilitiy for printing out tree we are traversing
    """
    print(
        """ 
                1
